...
// been successfully rendered by the image service, so a word is generated at
// most once across every recording. The queue handler writes a row only after
// the image bytes are on disk; absence of a row means "not generated"
// (placeholder).
//
