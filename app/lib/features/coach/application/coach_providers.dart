...
// (create/update/delete) invalidate it so the list refetches atomically. The
// vocab picker reads [allTextWordLogsProvider]; the recordings picker reuses
// the shared [recordingsProvider].
